...
Holds canonical type contracts referenced by [API_SPEC](../../docs/specifications/API_SPEC.md) and
[ADR-0001: Monorepo](../../docs/architecture/adrs/ADR-0001-monorepo.md).
